...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/mine3.jpg');">
              ...
              <div class="row">
                ...
                <div class="col-xl-7 d-flex align-items-center">
                  <div class="card-body">
                    ...
                    <p><b>Mignada</b> est une ville et une sous-préfecture de Guinée, rattachée à la préfecture de Siguiri et la région de Kankan.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-7 d-flex align-items-center">
                  <div class="card-body">
                    ...
                    <p><b>DIDI</b>est une ville et une sous-préfecture de Guinée rattachée à la préfecture de Siguiri et la région de Kankan.</p>
                  </div>
                </div>
              </div>
            </div>
